...
n_values = [3, 5, 7, 11, 13, 20] # the n-values we want
...
for n in n_values:
    ...
    plot(x2_values, f(x2_values),
         axis=[-2, 2, min(f(x2_values)), max(f(x2_values))], legend='Exact', 
         title="Plot of the exact curve and the curve generated by Lagrange's interpolation formula") # plot of the exact curve

    hold('on')

    plot(x1_values, y1_values, 'o' , x2_values, y2_values, 'b',
